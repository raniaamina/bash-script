...
echo "Masukkan nama untuk arsip hasil ekspor Anda (tanpa imbuhan .zip)"
read -p "Berkas: " NAMA_OUTPUT
read -e -p "Tulis Sebuah Nama Folder untuk Menyimpan Hasil Akhir: " TEMPAT_OUTPUT
echo "Memproses..."
...
echo "Selesai!"
echo "Berkas Anda telah di simpan di $TEMPAT_OUTPUT"
echo 
